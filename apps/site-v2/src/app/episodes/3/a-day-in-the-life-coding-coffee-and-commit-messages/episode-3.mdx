...
metadata: ["routine", "ai", "design-systems", "two-takes-and-a-fake", "spicy-takes", "note-taking"]
...
This episode of the Bikeshed Podcast dives into the daily routines of the hosts (Matt, Scott, and Dillon), exploring their productivity habits and workflows. They also discuss a few "spicy takes" related to software engineering and design systems.
...
The hosts played a round of "Two Takes and a Fake," a game where they presented three tech-related statements (two real, one fake) and challenged each other to identify the fabrication. Dillon won this round.

What's New

* Scott: Been working with UI heavy work to animate webm video files on scroll.
