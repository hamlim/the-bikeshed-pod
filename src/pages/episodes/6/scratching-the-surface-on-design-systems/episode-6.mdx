...
shortDescription: "The bikeshed boys talk all about design systems, ranging from what they are, why you may (or may not) need one, and then share a few spicy takes on Storybook, modals, and Tailwind!"
...
<div className="flex items-center justify-center">
  ![An image of Mr. Krabs from Spongebob, with a dizzy-like effect around
  him](/mr-krabs.jpeg)
</div>
