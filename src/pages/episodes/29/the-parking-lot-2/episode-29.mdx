...
metadata: ['ai', 'parking-lot', 'bun', 'enshittification', 'whoop', 'airbnb', 'hubspot', 'layoffs', 'pi']
...
- **Dillon:** measuring AI success by **PRs merged** is measuring too early — *"I could ship one PR a month but make the KPI skyrocket."* Quality over quantity.
