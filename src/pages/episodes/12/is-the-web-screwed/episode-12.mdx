...
shortDescription: "AI crawlers killing ads, chatbots replacing browsers, and the slow death of human-centric content. The gang debates whether we're heading for a hard fork of the web or just a really awkward transition."
hosts: ['dillon', 'scott', 'matt']
metadata: ['ai', 'web-development']
publishTime: 1761255617271
duration: 3136
